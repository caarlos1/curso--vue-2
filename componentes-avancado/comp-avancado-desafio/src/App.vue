<template>
  <div id="app">
    <span>
      <button id="Vermelho" @click="ativarComponente" class="vermelho">
        Carregar Componente Vermelho
      </button>
      <button id="Verde" @click="ativarComponente" class="verde">
        Carregar Componente Verde
      </button>
      <button id="Azul" @click="ativarComponente" class="azul">
